...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 07 Nov 2022 pada 14.53
...
(17, 'From Hobby to Money', 4, 'Deasylawati', 'Elex Media Komputindo', 2015, '87968686787879', 5, 0, 0, 'img1557403658');
...
CREATE TABLE `role` (
  `id` int(11) NOT NULL,
  `role` varchar(28) CHARACTER SET latin1 COLLATE latin1_swedish_nopad_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
